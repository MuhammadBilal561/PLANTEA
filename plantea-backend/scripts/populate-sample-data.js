...
async function populateSampleData() {
  ...
  try {
    ...
    // Insert subscription for seller (ignore if exists)
    ...
    if (subError) {
      ...
      console.log('✅ Subscription ensured for seller');
    }

    // Clear existing plants and insert fresh ones
    await supabase.from('plants').delete().eq('seller_id', '22222222-0000-0000-0000-000000000002');
